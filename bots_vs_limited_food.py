...
population_size = 8
number_of_food = 2
weights = get_weights("./limited_food/limited_food")
...
for _ in range(1000):
    ...
    fitness_to_file("limited_food/bots_fitness.csv",bots_fitness)
    fitness_to_file("limited_food/snakes_fitness.csv",snake_fitness)