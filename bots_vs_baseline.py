...
population_size = 8
number_of_food = 10
weights = get_weights("./baseline/weights/baseline")
...
sim :Simulation = init_simulation(0,number_of_food, EvolvingBehavior, trained_weights,fov,True, Renderer.yellow)
...
for _ in range(1000):
    ...
    # fitness_to_file("baseline/bots_fitness.csv",bots_fitness)
    # fitness_to_file("baseline/snakes_fitness.csv",snake_fitness)