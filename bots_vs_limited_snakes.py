...
population_size = 1
number_of_food = 10
weights = get_weights("./limited_snakes/two_snakes")
...
for _ in range(1000):
    ...
    fitness_to_file("limited_snakes/bots_fitness.csv",bots_fitness)
    fitness_to_file("limited_snakes/snakes_fitness.csv",snake_fitness)